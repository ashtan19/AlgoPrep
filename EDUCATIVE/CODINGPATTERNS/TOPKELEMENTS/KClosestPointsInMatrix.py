"""
Question: 'K' Closest Points to the Origin (easy)

Time Complexity: O(nlogk)
Space Complexity: O(k)

Pattern: K Closest Points
Technique: Need to overload Point class by having a __lt__ function that allows comparisions between points. 
            That way we can compare points and put then in a maxheap.
